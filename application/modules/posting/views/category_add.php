...
?>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <input  name="category_name" placeholder="Nama Kategori" type="text" class="form-control" value="<?php echo $category_name; ?>">
        ...
        <div class="col-sm-9 col-md-3">
            ...
            <a href="<?php echo site_url('manage/posting/category'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</a>
            <?php if (isset($category)): ?>
                <a href="<?php echo site_url('manage/posting/delete_category/' . $category['category_id']); ?>" class="btn btn-danger" style="margin-top: 3px"><i class="ion-trash-a"></i> Hapus</a>
            <?php endif; ?>
        </div>
        <?php echo form_close(); ?>
    </div>
