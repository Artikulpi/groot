...
<?php endif; ?>
        ...
        $scope.addCategory = function() {
            ...
            $http({method: 'POST', headers: {'Content-Type': 'application/x-www-form-urlencoded'}, url: '<?php echo site_url('manage/posting/add_category'); ?>', data: "category_name=" + $scope.categoryText + "&<?php echo $this->security->get_csrf_token_name(); ?>=" + cct}).
