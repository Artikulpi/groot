    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-3">
            ...
            <div class="form-group">
                ...
                <?php if (isset($page)): ?>
                    <a href="<?php echo site_url('manage/page/delete/' . $page['page_id']); ?>" class="btn btn-danger" style="margin-top: 3px"><i class="ion-trash-a"></i> Hapus</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="confirm-del">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('manage/page/delete/' . $page['page_id']); ?>
