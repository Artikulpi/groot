...
class User extends CI_Controller {
    ...
    public function index($offset = NULL) {
        ...
        $data['title'] = 'Pengguna';
        $data['main'] = 'g_admin/user/user_list';
        $config['base_url'] = site_url('g_admin/index');
    ...
    public function add($id = NULL) {
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            redirect('g_admin/user');
        } else {
            if ($this->input->post('user_id')) {
                redirect('g_admin/user/edit/' . $this->input->post('user_id'));
            }
            ...
            $data['main'] = 'g_admin/user/user_add';
            $this->load->view('g_admin/layout', $data);
        }
    }
    ...
    function detail($id = NULL) {
        ...
        $data['main'] = 'g_admin/user/user_detail';
        $this->load->view('g_admin/layout', $data);
    }
    ...
    function rpw($id = NULL) {
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            $data['main'] = 'g_admin/user/change_pass';
            $this->load->view('g_admin/layout', $data);
        }
    }
