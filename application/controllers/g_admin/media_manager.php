...
class Media_manager extends CI_Controller {
    ...
    public function index($offset = 0) {
        ...
        $config['base_url'] = site_url('g_admin/media_manager/index/');
        $config['total_rows'] = $data['total_images'];
        $config['per_page'] = $this->Mediamanager_model->limit;

        $this->pagination->initialize($config);
        $data['main'] = 'g_admin/media_manager/list';
    ...
    public function add($id) {
        ...
        if ($exists) {
            if (isset($_POST['id'])) {
                ...
                if ($ok) {
                    ...
                    redirect('g_admin/media_manager/');
                } else {
        ...
        $data['main'] = 'g_admin/media_manager/edit';
    ...
    public function upload() {
        ...
        if ($this->input->post('id')) {
            redirect('g_admin/media_manager/album/' . $this->input->post('id'));
        } else {
            redirect('g_admin/media_manager');
        }
    }
    ...
    public function popup($keyword = '', $offset = 0) {
        ...
        //$this->load->view('g_admin/media_manager/popup', $data);
        /*
         * Rewrite
         */
        $data = array();

        $this->load->view('g_admin/media_manager/popupex', $data);
    }
    ...
    public function listAjax($offset = 1, $isfile = 0) {
        ...
        $config['base_url'] = site_url('g_admin/media_manager/popup/');
        $config['total_rows'] = $data['total_images'];
        $config['per_page'] = $this->Mediamanager_model->limit;
