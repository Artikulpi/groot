...
<html lang="en">
    <head>
        ...
        <link href="<?php echo media_url('/css/style-login.css') ?>" rel="stylesheet" type="text/css">

        <script src="<?php echo media_url('/js/jquery-1.11.1.min.js') ?>" type="text/javascript"></script>
        <script src="<?php echo media_url('/js/bootstrap.min.js') ?>" type="text/javascript"></script>
        <script src="<?php echo media_url('/js/template.js') ?>" type="text/javascript"></script>
