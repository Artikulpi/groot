...
<div class="col-sm-9 col-md-10 main">
    ...
    <div class="row page-header">
        <div class="col-sm-9 col-md-6">
            <h3 class="page-title"><?php echo $operation; ?> Kategori Berita</h3>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-3">
            ...
            <a href="<?php echo site_url('manage/news/category'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</a>
            <?php if (isset($category)): ?>
                <a href="<?php echo site_url('manage/news/delete_category/' . $category['category_id']); ?>" class="btn btn-danger" style="margin-top: 3px"><i class="ion-trash-a"></i> Hapus</a>
            <?php endif; ?>
        </div>
        <?php echo form_close(); ?>
    </div>
    ...
    <div class="modal fade" id="confirm-del">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('manage/news/delete_category/' . $category['category_id']); ?>
