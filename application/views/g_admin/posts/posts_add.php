        ...
        <div class="col-sm-9 col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="row" style="margin-top: 3px">
                    <a href="<?php echo site_url('g_admin/posts'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</a>
                    <?php if (isset($posts)): ?>
                        <a href="<?php echo site_url('g_admin/posts/delete/' . $posts['posts_id']); ?>" class="btn btn-danger" ><i class="ion-trash-a"></i> Hapus</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="confirm-del">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('g_admin/posts/delete/' . $posts['posts_id']); ?>
