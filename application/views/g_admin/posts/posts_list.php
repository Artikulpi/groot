<div class="col-sm-9 col-md-10 main">
    <h3 class="page-header">
        Daftar Posting
        <a href="<?php echo site_url('g_admin/posts/add'); ?>" ><button type="button" class="btn btn-success pull-right"><span class="glyphicon glyphicon-plus-sign"></span> Tambah</button></a><br><br>
    </h3>
        ...
        <table class="table table-striped">
            ...
            if (!empty($posts)) {
                foreach ($posts as $row) {
                    ...
                    <tbody>
                        <tr>
                            <td ><b><a style="float: left;" href="<?php echo site_url('g_admin/posts/edit/' . $row['posts_id']); ?>" ><?php echo $row['posts_title']; ?></a></b></td>
