<?php
$this->load->view('g_admin/tinymce_init');
if (isset($user)) {
    $id = $user['user_id'];
...
<div class="col-sm-9 col-md-10 main">
    ...
    <div class="row page-header">
        <div class="col-sm-9 col-md-6">
            <h3 class="page-title" ><?php echo $operation; ?> Admin</h3>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-3">
            <div class="form-group">
                ...
                <a href="<?php echo site_url('g_admin/user'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</a>
                <?php if (isset($user)): ?>
                    <?php if ($this->session->userdata('user_id_admin') != $id) {
                        ?>
                        <a style="margin-top: 3px" href="<?php echo site_url('g_admin/user/delete/' . $user['user_id']); ?>" class="btn btn-danger"><i class="ion-trash-a"></i> Hapus</a>
                    <?php } ?>
                    <?php if ($this->session->userdata('user_id_admin') == $id) {
                        ?>
                        <a href="<?php echo site_url('g_admin/profile/cpw') ?>" class="btn btn-primary" style="margin-top: 3px"> Ubah password</a>
                    <?php } elseif ($this->session->userdata('user_id_admin') != $id) { ?>
                        <a style="margin-top: 3px" class="btn btn-primary" href="<?php echo site_url('g_admin/user/rpw/' . $user['user_id']); ?>" > Reset Password</a>
                    <?php } ?>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="modal fade" id="confirm-del">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('g_admin/user/delete/' . $user['user_id']); ?>
