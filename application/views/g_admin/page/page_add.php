...
<?php $this->load->view('g_admin/datepicker'); ?>
...
if (isset($page)) {
    ...
    $inputDateValue = $page['page_publish_date'];
    ...
    $inputDateValue = set_value('page_publish_date');
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-3">
            ...
            <div class="form-group">
                ...
                <a href="<?php echo site_url('g_admin/page'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</a>
                <?php if (isset($page)): ?>
                    <a href="<?php echo site_url('g_admin/page/delete/' . $page['page_id']); ?>" class="btn btn-danger" style="margin-top: 3px"><i class="ion-trash-a"></i> Hapus</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="confirm-del">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('g_admin/page/delete/' . $page['page_id']); ?>
